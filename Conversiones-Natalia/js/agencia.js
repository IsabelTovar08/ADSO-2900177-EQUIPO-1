...
if (destino.toLocaleLowerCase() == "turquia" || destino.toLocaleLowerCase() == "italia" || destino.toLocaleLowerCase() == "peru" || destino.toLocaleLowerCase() == "chile" || destino.toLocaleLowerCase() == "guatemala" || destino.toLocaleLowerCase() == "brasil" || destino.toLocaleLowerCase() == "mexico"){
    ...
    else if (destino.toLowerCase() == "italia"){
    ...
    else if (destino.toLowerCase() == "peru"){
    ...
    else if (destino.toLowerCase() == "chile"){
    ...
    else if (destino.toLowerCase() == "guatemala"){
    ...
    else if (destino.toLowerCase() == "brasil"){
    ...
    else if (destino.toLowerCase() == "mexico"){
